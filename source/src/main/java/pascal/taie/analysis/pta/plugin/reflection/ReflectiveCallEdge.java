...
public class ReflectiveCallEdge extends OtherEdge<CSCallSite, CSMethod> {
    ...
    /**
     * Mock variable whose pts holds all objects pointed to by any
     * arrayIndex in pts(args)
     */
    private final Var argHub;

    ReflectiveCallEdge(CSCallSite csCallSite, CSMethod callee,
                       @Nullable Var args, Var argHub) {
