...
public interface Solver {
    ...
    /**
     * For plugins to get the unified return edge transfer.
     */
    Transfer getRetEdgeTransfer();

    /**
     * For plugins to get the unified pass edge transfer.
     */
    Transfer getPassEdgeTransfer();

    /**
     * @return the allowing propagation types of the solver.
     */
    PropagateTypes getPropagateTypes();
