...
public interface PointerAnalysisResult extends ResultHolder {
    ...
    /**
     * @return all reachable context-sensitive non-mock variables in the program.
     */
    Collection<CSVar> getFunctionalCSVars();
    ...
    /**
     * @return all reachable non-mock variables in the program.
     */
    Collection<Var> getFunctionalVars();
    ...
    /**
     * @return all reachable context-sensitive functional objects in the program.
     */
    Collection<CSObj> getFunctionalCSObjects();
    ...
    /**
     * @return all reachable functional objects in the program.
     */
    Collection<Obj> getFunctionalObjects();
    ...
    Set<Obj> getAllPointsToSet(Var var);
